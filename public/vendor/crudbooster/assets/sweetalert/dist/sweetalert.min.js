    ...
    !function o(e, t, n) {
            ...
            function (o, a, r) {
                ...
                r["default"] = u = c = function () {
                    ...
                    switch (typeof a) {
                        ...
                        default:
                            return f.logStr(
                                'Unexpected type of argument! Expected "string" or "object", got ' + typeof a
                            ),
                            !1
                    }
                    w["default"](r),
                    ...
                    for (var u = p.getModal(), v = u.querySelectorAll("button"), h = [
                        "onclick",
                        "onmouseover",
                        "onmouseout",
                        "onmousedown",
                ...
                var a = t("./utils"),
                    ...
                    s = function (t, n, o) {
                        ...
                        var u,
                            ...
                            v = -1 !== p
                                .className
                                .indexOf("sweet-overlay"),
                            y = r.hasClass(o, "visible"),
                            h = n.doneFunction && "true" === o.getAttribute("data-has-done-function");
                        switch (m && n.confirmButtonColor && (
                ...
                var r = function (e, t) {
                    ...
                    m = function (e) {
                        ...
                        return t = "undefined" != typeof getComputedStyle
                            ? parseInt(getComputedStyle(e).getPropertyValue("padding-top"), 10)
                        ...
                        if (+e.style.opacity < 1) {
                            ...
                            var n = +new Date,
                                o = function (e) {
                                    ...
                                    n = +new Date, + e.style.opacity < 1 && setTimeout(o, t)
                                });
                            o()
                        }
                        e.style.display = "block"
                        ...
                        if (-1 !== [9, 13, 32, 27].indexOf(i)) {
                            ...
                            9 === i
                                ? (
                                    ...
                                    f.focus(),
                                    o.confirmButtonColor && s.setFocusStyle(f, o.confirmButtonColor)
                                )
                                : 13 === i
                                    ? (
        ...
        7: [
            function (e, t, n) {
                ...
                var o = '<div class="sweet-overlay" tabIndex="-1"></div><div class="sweet-alert"><div c' +
                        'lass="sa-icon sa-error">\n      <span class="sa-x-mark">\n        <span class=' +
                        '"sa-line sa-left"></span>\n        <span class="sa-line sa-right"></span>\n   ' +
                        '   </span>\n    </div><div class="sa-icon sa-warning">\n      <span class="sa-' +
                        'body"></span>\n      <span class="sa-dot"></span>\n    </div><div class="sa-ic' +
                        'on sa-info"></div><div class="sa-icon sa-success">\n      <span class="sa-line' +
                        ' sa-tip"></span>\n      <span class="sa-line sa-long"></span>\n\n      <div cl' +
                        'ass="sa-placeholder"></div>\n      <div class="sa-fix"></div>\n    </div><div ' +
                        'class="sa-icon sa-custom"></div><h2>Title</h2>' +
                        '\n    <p>Text</p>\n    <fieldset>\n      <input type="text" tabIndex="3" />\n ' +
                        '     <div class="sa-input-error"></div>\n    </fieldset><div class="sa-error-c' +
                        'ontainer">\n      <div class="icon">!</div>\n      <p>Not valid!</p>\n    </di' +
                        'v><div class="sa-button-container">\n      <button class="cancel" tabIndex="2"' +
                        '>Cancel</button>\n      <div class="sa-confirm-button-container">\n        <bu' +
                        'tton class="confirm" tabIndex="1">OK</button><div class="la-ball-fall">\n     ' +
                        '     <div></div>\n          <div></div>\n          <div></div>\n        </div>' +
                        '\n      </div>\n    </div></div>';
                n["default"] = o,
                t.exports = n["default"]
                        ...
                        if (e.imageUrl) {
                            ...
                            if (e.imageSize) {
                                ...
                                h && b
                                    ? (m = h, v = b)
                                    : logStr(
                                        "Parameter imageSize expects value with format WIDTHxHEIGHT, got " + e.imageSize
                                    )
                            }
                            p.setAttribute(
                                "style",
