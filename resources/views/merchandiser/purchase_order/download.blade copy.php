...
<body style="background-color: #ffffff;">
    ...
    <div class="content">
        ...
        <table width="100%" style="border-collapse: collapse; font-size: 0.85rem; page-break-inside: auto;">
            ...
            <tbody>
                ...
                <tr style="page-break-inside: avoid;">
                    <td style="border: 1px solid black; padding: 0.5rem; text-align: center;">{{ ++$k }}</td>
                    <td style="border: 1px solid black; padding: 0.5rem;">{{ $v->ItemCode }} - {{ $v->item->name }}</td>
                    <td style="border: 1px solid black; padding: 0.5rem; text-align: center;">{{ nominal($v->Quantity) }}</td>
                    <td style="border: 1px solid black; padding: 0.5rem; text-align: center;">{{ $v->item->unit_of_measurement }}</td>
                    <td style="border: 1px solid black; padding: 0.5rem; text-align: right;">
                ...
                @if ($po->items->count() > 5)
                    <tr>
                        <td colspan="6" style="padding: 5px; border-bottom:1px solid black; border-left: 1px solid black; border-right: 1px solid black; height: 80%;">&nbsp;</td>
                    </tr>
                @endif
            </tbody>
            <tfoot>
